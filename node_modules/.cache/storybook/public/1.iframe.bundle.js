...
/* harmony import */ var _storybook_docs_tools__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @storybook/docs-tools */ "./node_modules/@storybook/docs-tools/dist/esm/index.js");
...
var getNotes = function getNotes(notes) {
  return notes && (typeof notes === 'string' ? notes : Object(_storybook_docs_tools__WEBPACK_IMPORTED_MODULE_7__["str"])(notes.markdown) || Object(_storybook_docs_tools__WEBPACK_IMPORTED_MODULE_7__["str"])(notes.text));
};

var getInfo = function getInfo(info) {
  return info && (typeof info === 'string' ? info : Object(_storybook_docs_tools__WEBPACK_IMPORTED_MODULE_7__["str"])(info.text));
};
